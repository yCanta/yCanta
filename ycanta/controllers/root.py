...
from ycanta.controllers.error import ErrorController
...
class RootController(BaseController):
    """
    The root controller for the yCanta application.
    ...
    @expose('ycanta.templates.about')
    def about(self):
        """Handle the 'about' page."""
        return dict(page='about')

    @expose('ycanta.templates.environ')
    def environ(self):
        """This method showcases TG's access to the wsgi environment."""
        return dict(page='environ', environment=request.environ)

    @expose('ycanta.templates.data')
    @expose('json')
    def data(self, **kw):
