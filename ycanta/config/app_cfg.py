# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in yCanta.
...
from ycanta.lib import app_globals, helpers 
...
base_config.model = ycanta.model
base_config.DBSession = ycanta.model.DBSession
# Configure the authentication backend

# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP 
base_config.sa_auth.cookie_secret = "3fcd2322-6504-4d20-9fc7-7b9b5ef001a8"
